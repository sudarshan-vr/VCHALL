    ...
    scoreData: [
        {
            number: 500,
            numberValue: '',
            scoreDescp: "Events Hosted"
        },
        {
            number: 150,
            scoreDescp: "Positive Reviews"
        },
        {
            number: 4,
            numberValue: '.5',
            scoreDescp: "Average Rating"
        },
    ]
};
    ...
    data: [
        {
            ...
            heading: "Weddings",
            descp: "Our team has helped to create several perfect weddings and receptions and has been rated as one of the best wedding halls in Bangalore."
        },
        {
            id: 2,
            image: "/images/home/services/services_2.png",
            heading: "Exhibitions",
            descp: "Vijayalakshmi Convention Hall is the perfect venue for premier retail and trade exhibitions, corporate events and gatherings."
        },
        {
            id: 3,
            image: "/images/home/services/services_4.png",
            heading: "Concerts",
            descp: "Perfect for live performances, the VCHALL has played host to many well-attended concerts, music shows, parties and large gatherings."
        },
        {
            id: 4,
            image: "/images/home/services/services_3.png",
            heading: "Events",
            descp: "Make your event unforgettable at Vijayalakshmi Convention Hall. Our Convention Hall is the perfect space for live performances, from concerts to theater productions. Our team will work with you to ensure that your event is seamless and unforgettable."
        },
    ]
};
