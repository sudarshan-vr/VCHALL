                    ...
                    <div className="flex flex-col gap-24">
                        ...
                        <div className="flex flex-col md:flex-row relative gap-10 2xl:gap-56">
                            ...
                            <div className="w-full flex flex-col gap-16">
                                <div>
                                    {servicesData?.data.map((value: ServiceItem, index: number) => (
                                        <div
                                            key={index}
                                ...
                                <div>
                                    <Link href="" className="group flex gap-4 items-center w-fit bg-primary border border-primary hover:border hover:border-white/30 hover:bg-secondary rounded-full transition-all duration-200 ease-in-out">
                                        <span className="pl-6 text-lg font-bold text-secondary group-hover:text-white group-hover:translate-x-12 transform transition-transform duration-200 ease-in-out">Our Services</span>
